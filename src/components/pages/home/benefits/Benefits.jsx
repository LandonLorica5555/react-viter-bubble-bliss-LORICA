        ...
        <section id="benefits" className="bg-white p-4">
            <div className="container max-w-6xl mx-auto py-20 grid grid-cols-1 md:grid-cols-2 justify-items-center items-center">
              <div className="mb-10 md:mb-0">
                <h2 className="text-4xl text-black font-bold mb-4">Why <span className="text-4xl font-bold bg-gradient-to-r from-purple-500 to-pink-500 bg-clip-text text-transparent">Milk Tea</span> is Good For You</h2>
                <div className="grid grid-cols-1">
                  <ul className="flex flex-row items-center gap-4 mb-4">
                    ...
                    <li>
                      ...
                      <p className="">Tea contains polyphenols that help fight free radicals.</p>
                    </li>
                  </ul>
                  <ul className="flex flex-row items-center gap-4 mb-4">
                    <li>
                  ...
                  <ul className="flex flex-row items-center gap-4 mb-4">
                    ...
                    <li>
                      ...
                      <p className="">The comforting warmth and sweetness can brighten your day.</p>
                    </li>
                  </ul>
                </div>
              </div> 
              <div className="bg-purple-200/80 size-60 rounded-xl shadow-md justify-items-center">
                <div className="items-center justify-items-center">
                  <p className="text-8xl">💖</p>
                  <p className="font-bold max-w-48">"A cup of milk tea a day keeps the stress away!"</p>
                </div>
              </div>
            </div>
        </section>
